...
class DongkapLocalizations {
  ...
  static DongkapLocalizations? _current;

  static DongkapLocalizations get current {
    assert(_current != null,
        'No instance of DongkapLocalizations was loaded. Try to initialize the DongkapLocalizations delegate before accessing DongkapLocalizations.current.');
    return _current!;
  }
  ...
  static Future<DongkapLocalizations> load(Locale locale) {
    ...
    return initializeMessages(localeName).then((_) {
      ...
      final instance = DongkapLocalizations();
      DongkapLocalizations._current = instance;
  ...
  static DongkapLocalizations of(BuildContext context) {
    final instance = DongkapLocalizations.maybeOf(context);
    assert(instance != null,
        'No instance of DongkapLocalizations present in the widget tree. Did you add DongkapLocalizations.delegate in localizationsDelegates?');
    return instance!;
  }

  static DongkapLocalizations? maybeOf(BuildContext context) {
    return Localizations.of<DongkapLocalizations>(
        context, DongkapLocalizations);
  }
...
class AppLocalizationDelegate
    extends LocalizationsDelegate<DongkapLocalizations> {
  ...
  @override
  Future<DongkapLocalizations> load(Locale locale) =>
      DongkapLocalizations.load(locale);
  @override
