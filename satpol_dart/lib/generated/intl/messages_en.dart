...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) => "${value} Days";

  static String m1(value) => "Enter the code before ${value}";

  static String m2(value) => "Enter the code sent to ${value}";

  static String m3(value) => "Logged in with ${value}?";

  static String m4(value) =>
      "Are you sure want to change the language into ${value}?";

  static String m5(value) => "Are you sure want to change to ${value}?";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "badgeExerciseTitle":
            MessageLookupByLibrary.simpleMessage("Next workout"),
        ...
        "errorFullname":
            MessageLookupByLibrary.simpleMessage("Fullname is required!"),
        ...
        "errorPlaceOfBirth":
            MessageLookupByLibrary.simpleMessage("Place of Birth is required!"),
        "errorUsername":
        ...
        "forgotPasswordVerification": MessageLookupByLibrary.simpleMessage(
        ...
        "labelFooterLoginSocial":
            MessageLookupByLibrary.simpleMessage("or enter with"),
        "labelForgotPassword":
        ...
        "userAccountHasExpired":
            MessageLookupByLibrary.simpleMessage("Account has been expired"),
        "userAccountIsLocked":
            MessageLookupByLibrary.simpleMessage("Account has been locked"),
        "userCredentialsHaveExpired": MessageLookupByLibrary.simpleMessage(
            "Account credentials has been expired"),
        "userIsDisabled": MessageLookupByLibrary.simpleMessage(
